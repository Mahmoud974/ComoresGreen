...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Hydroelectric power plants can include a reservoir to exploit the energy of falling water"
    },
    {
      icon: (
        <svg className='w-12 h-12' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          {services.map((service, index) => (
            <div key={index} className='bg-white rounded-lg shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
              {/* Icon */}
              <div className='w-16 h-16 mx-auto mb-6 border-2 border-green-500 rounded-full flex items-center justify-center text-green-500'>
                {service.icon}
              </div>
